class AppointmentsController < ApplicationController
  ...
  before_action :set_appointment, only: [:show, :edit, :update, :destroy, :reminder]
  ...
  def reminder
    ...
    Reminder.send_reminder(@appointment.customer_id, @appointment.appointment_date).deliver_now
